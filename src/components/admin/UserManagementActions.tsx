...
const ALL_ROLES = [
  ...
  { value: "operations_manager", label: "Originator: Operations Manager" },
  { value: "account_manager", label: "Originator: Account Manager" },
  { value: "credit_committee_member", label: "Originator: Credit Committee" },
